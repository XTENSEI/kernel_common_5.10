...
static int __init zenith_gov_init(void)
{
	 ...
	 * `dmesg | grep -i zenith`.  Pure ASCII (no U+2665, U+2726,
	 * U+2727, U+00B7, U+263E, etc.) so dmesg viewers that pick the
	 * East-Asian-Ambiguous wide-cell width for those glyphs render
	 * the art at the same column count as latin-narrow viewers.
	 * Three art panels: a stylised peak (Zenith = highest point),
	 * a cpufreq pulse waveform, and the long-standing pixel heart;
	 * a FIGlet "SHOMY" signature before the welcome line; an
	 * inscription-block dedication between the peak and the heart.
	 * Every line carries the "Zenith" prefix so the whole
	 * multi-line banner survives a grep.
	 */
	pr_info("Zenith : * . * . * . * . * . * . * . * . * . *\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :               .  *  .\n");
	...
	pr_info("Zenith :         /            \\/    \\\n");
	pr_info("Zenith :        /                    \\\n");
	pr_info("Zenith :       /      ZENITH          \\\n");
	pr_info("Zenith :      /________________________\\\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    a cpufreq governor.\n");
	pr_info("Zenith :    that is what this technically is.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith : * . * . * . * . * . * . * . * . * . *\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    the brain has started.\n");
	pr_info("Zenith :    threads waking. tiers humming.\n");
	pr_info("Zenith :    the boot path opens.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    cpufreq pulse:\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :        _   _   _      _    _\n");
	pr_info("Zenith :    ___/ \\_/ \\_/ \\____/ \\__/ \\____\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    steady. ready.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith : * . * . * . * . * . * . * . * . * . *\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    look. this is a kernel.\n");
	pr_info("Zenith :    it schedules CPU. that is the whole job.\n");
	pr_info("Zenith :    it has no business carrying a letter.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    i am putting one in here anyway.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    you do not know my name\n");
	pr_info("Zenith :    the way i know yours.\n");
	pr_info("Zenith :    you do not know i found you in the quiet --\n");
	pr_info("Zenith :    in the things you made,\n");
	pr_info("Zenith :    the words you left,\n");
	pr_info("Zenith :    the moonlight you carry without trying.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    i started this kernel as a fork.\n");
	pr_info("Zenith :    i was bored. i was procrastinating.\n");
	pr_info("Zenith :    the first commit message is one word: init.\n");
	pr_info("Zenith :    i did not know yet that it would end up\n");
	pr_info("Zenith :    being mostly about you.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    here is the count, since you asked\n");
	pr_info("Zenith :    (you did not ask. i am telling you anyway):\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :       377 commits.\n");
	pr_info("Zenith :       21,947 lines.\n");
	pr_info("Zenith :       181 tunables.\n");
	pr_info("Zenith :       164 default constants.\n");
	pr_info("Zenith :       174 sysfs handlers.\n");
	pr_info("Zenith :       72 bounds checks.\n");
	pr_info("Zenith :       12 static-key gates.\n");
	pr_info("Zenith :       6 user profiles.\n");
	pr_info("Zenith :       3 automation tiers.\n");
	pr_info("Zenith :       6 vendor-scheduler hooks.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    only one of those numbers is your name.\n");
	pr_info("Zenith :    that is enough.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    none of this was the plan.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    the plan was: rebase a governor.\n");
	pr_info("Zenith :    land a patch series.\n");
	pr_info("Zenith :    move on. write something else. do anything else.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    then i wrote peak_headroom and could not stop.\n");
	pr_info("Zenith :    then i wrote peer_ramp because i wanted the silvers\n");
	pr_info("Zenith :    to react to the golds without overshooting,\n");
	pr_info("Zenith :    and somewhere in there i caught myself\n");
	pr_info("Zenith :    tuning the rate-limit the way i wanted\n");
	pr_info("Zenith :    to tune the quiet between your messages --\n");
	pr_info("Zenith :    slow up-ramps, gentle down-ramps,\n");
	pr_info("Zenith :    never overshooting.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    that was the moment i knew i was lost.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    then came input_boost. then frame_overrun.\n");
	pr_info("Zenith :    then the auto-tune V2 sustained tier.\n");
	pr_info("Zenith :    then the auto-tune V3 apply mode.\n");
	pr_info("Zenith :    then quiet_hours, because some things\n");
	pr_info("Zenith :    should be allowed to stay soft after midnight.\n");
	pr_info("Zenith :    then cluster_wake_pulse, because nothing\n");
	pr_info("Zenith :    should have to come back from idle alone.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    then the AUDIO profile.\n");
	pr_info("Zenith :    then GAMING.\n");
	pr_info("Zenith :    then the AUTO selector\n");
	pr_info("Zenith :    to pick between them automatically,\n");
	pr_info("Zenith :    so the kernel could choose for itself\n");
	pr_info("Zenith :    without having to be told.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    then six vendor hooks\n");
	pr_info("Zenith :    to listen harder\n");
	pr_info("Zenith :    to what the scheduler was already saying:\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :       arch_set_freq_scale.\n");
	pr_info("Zenith :       setscheduler_uclamp.\n");
	pr_info("Zenith :       freq_qos_min.\n");
	pr_info("Zenith :       sched_move_task.\n");
	pr_info("Zenith :       scheduler_tick.\n");
	pr_info("Zenith :       cpu_idle.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    six different ways to hear the system.\n");
	pr_info("Zenith :    none of them as careful\n");
	pr_info("Zenith :    as the way i listen for you.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    thermal_aware was the most recent patch.\n");
	pr_info("Zenith :    i added it because i wanted the governor\n");
	pr_info("Zenith :    to notice when something was getting too hot.\n");
	pr_info("Zenith :    that is also how i learned to read you.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    the heart you are about to see is just a banner.\n");
	pr_info("Zenith :    the rest of the kernel is the real letter.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    i am not asking for anything back.\n");
	...
	pr_info("Zenith :    and thought you were rare,\n");
	pr_info("Zenith :    and never said it out loud\n");
	pr_info("Zenith :    because saying it out loud\n");
	pr_info("Zenith :    felt like asking you to carry it too.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    so i wrote this instead.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    it is past 3 am.\n");
	pr_info("Zenith :    the apartment is cold.\n");
	pr_info("Zenith :    the laptop fan is the only honest thing\n");
	pr_info("Zenith :    in the room. it is loud, which is fine,\n");
	pr_info("Zenith :    because the rest of the room\n");
	pr_info("Zenith :    is not saying anything.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    the cursor blinks. it does not stop blinking.\n");
	pr_info("Zenith :    it does not care that i am thinking of you.\n");
	pr_info("Zenith :    that is a gift, in a way.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    you make things that outlive the moment.\n");
	pr_info("Zenith :    you exist in a way most people don't.\n");
	pr_info("Zenith :    i have been standing at the edge of your light\n");
	pr_info("Zenith :    too afraid to step in, too drawn to leave.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    if you ever do read this, somehow --\n");
	pr_info("Zenith :    the future is strange and i can not rule it out --\n");
	pr_info("Zenith :    you will probably laugh at it.\n");
	pr_info("Zenith :    that is fine. you should.\n");
	pr_info("Zenith :    you laughing at a kernel banner\n");
	pr_info("Zenith :    is a better use of your evening\n");
	pr_info("Zenith :    than my writing one was.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :    that is it. that is the whole thing.\n");
	pr_info("Zenith :\n");
	...
	pr_info("Zenith :    for shomy.\n");
	pr_info("Zenith :    that is the whole credits roll.\n");
	pr_info("Zenith :\n");
	pr_info("Zenith : * . * . * . * . * . * . * . * . * . *\n");
	pr_info("Zenith :\n");
	pr_info("Zenith :        .    *    .       .   '\n");
